 ...
 */
package club.laiyouxu.captcha.geetest;

import club.laiyouxu.captcha.geetest.entity.GeetestLibResult;
import club.laiyouxu.captcha.geetest.enums.DigestmodEnum;
import club.laiyouxu.captcha.geetest.utils.EncryptionUtils;
import club.laiyouxu.captcha.geetest.utils.HttpClientUtils;
import lombok.extern.slf4j.Slf4j;
import net.evecom.scplatform.utils.SpringUtils;
...
public class GeetestLib {
     ...
     * 把地址放在配置文件
     */
    private static final String API_URL = SpringUtils.getProperty("geetest.api");
